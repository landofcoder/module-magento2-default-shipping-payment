<?php
namespace Lof\DefaultShippingPayment\Model;
...
class CompositeConfigProvider implements ConfigProviderInterface
{
    ...
    public function getConfig()
    {
        ...
        return ['lofDefaultShippingPayment' => $config];
    }
    ...
    public function getConfigValue($type)
    {
        return $this->scopeConfig->getValue(
            sprintf('lof_default_shipping_payment/%s', $type),
    ...
    public function isEnabled($type)
    {
        return $this->scopeConfig->isSetFlag(
            sprintf('lof_default_shipping_payment/%s/autoselect_method', $type),
            ScopeInterface::SCOPE_STORE
        );
    }
}
