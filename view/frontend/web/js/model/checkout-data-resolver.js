    ...
    return function (checkoutDataResolver) {
        ...
        return _.extend(checkoutDataResolver, {
            ...
            getMethodBySelectionType: function (methodType, selectionType) {
                if (!_.isUndefined(config.lofDefaultShippingPayment)
                    && !_.isUndefined(config.lofDefaultShippingPayment[methodType])
                ) {
                    return config.lofDefaultShippingPayment[methodType][selectionType];
                }
            },
